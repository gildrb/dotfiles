...
function M.load()
  ...
  set("Visual", { fg = p.paper, bg = p.select })
  set("VisualNOS", { fg = p.paper, bg = p.select })
  ...
  set("QuickFixLine", { fg = p.red_bright, bg = p.select, bold = true })

  set("Pmenu", { fg = p.paper, bg = background })
  set("PmenuSel", { fg = p.paper, bg = p.select, bold = true })
  set("PmenuKind", { fg = p.cyan, bg = background })
  set("PmenuKindSel", { fg = p.red_bright, bg = p.select, bold = true })
  set("PmenuExtra", { fg = p.steel, bg = background })
  set("PmenuExtraSel", { fg = p.bone, bg = p.select })
  ...
  set("DiffAdd", { fg = p.green, bg = p.success_bg })
  set("DiffChange", { fg = p.gold, bg = p.surface })
  set("DiffDelete", { fg = p.red_bright, bg = p.error_bg })
  set("DiffText", { fg = p.paper, bg = p.surface, bold = true })
...
function M.plugins(background)
  ...
  set("NvimTreeWindowPicker", { fg = p.paper, bg = p.select, bold = true })
  ...
  set("FzfLuaCursor", { fg = p.paper, bg = p.select, bold = true })
  ...
  set("BlinkCmpMenuSelection", { fg = p.paper, bg = p.select, bold = true })
  ...
  set("LazyButtonActive", { fg = p.paper, bg = p.select, bold = true })
