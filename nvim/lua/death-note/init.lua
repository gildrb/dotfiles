...
function M.plugins(background)
  ...
  set("WhichKeyIcon", { fg = p.red_bright })
  ...
  set("SnacksDashboardIcon", { fg = p.red_bright })
  ...
  set("LazyH2", { fg = p.red_bright, bold = true })
  ...
  set("MasonHeaderSecondary", { fg = p.red_bright, bg = background, bold = true })
